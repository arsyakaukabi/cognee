    ...
    async def transcribe_image(self, input, **kwargs) -> BaseModel:
        ...
        --------
            ...
            - BaseModel: A structured output generated by the model, returned as an instance of
              BaseModel.
        """
        mime_guess, _ = mimetypes.guess_type(str(input))
        ...
        return litellm.completion(
            model=os.getenv("VISION_LLM_MODEL", self.model),
            messages=[
                {
                    "role": "user",
                    "content": [
            ...
            api_key=os.getenv("VISION_LLM_API_KEY", self.api_key),
            api_base=os.getenv("VISION_LLM_ENDPOINT", self.endpoint),
            api_version=os.getenv("VISION_LLM_API_VERSION", self.api_version),
